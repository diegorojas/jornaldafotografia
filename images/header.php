...
<div class="wrapper">
	...
	<header id="header" class="col-full">
	    ...
	    <hgroup>
			...
			<h2 class="site-description"><a href="http://www.fotospot.com.br"</h2>
	        	<nav class="nav cart" id="logo-header">
	        		<a href="http://www.fotospot.com.br"><img src="<?php bloginfo( 'stylesheet_directory' ) . '/images/logo-fotospot-75px-transparent.png'; ?>" title="Fotospot - Fotografia Autoral" alt="Fotospot - Fotografia Autoral"></a>
	       		</nav>
